// Every tracker weawr knows. To add one: write src/trackers/<id>.mjs against the contract in
 ...
 * (host, repo, …) when it is the same tracker, so `weawr login github` in a repo configured
