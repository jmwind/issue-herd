...
import { GitHubTracker, issueNumber, priorityFromLabels, repoFromRemote } from '../dist/adapters/trackers/github.mjs';
import { checkIssue } from '../dist/adapters/tracker.mjs';
import { compile } from '../dist/expr.mjs';
